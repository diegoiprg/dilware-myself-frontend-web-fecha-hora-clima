...
export default function MainContent() {
  ...
  return (
    ...
    >
      ...
      <div className="h-full w-full max-w-none landscape:max-w-[90%] mx-auto grid grid-rows-[auto_auto_1fr_auto_auto] landscape:grid-rows-[1fr_3fr_1fr] landscape:grid-cols-2 place-items-center p-2 sm:p-4 md:p-6 lg:p-8">
